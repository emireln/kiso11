# Kiso11 - Windows 11 ISO Debloater & Optimizer Engine
# Rebranded and optimized for Windows 11 (24H2, 23H2) & Windows 10
...
Write-Host "Starting Kiso11 Optimization Engine..." -ForegroundColor Green
Start-Sleep -Milliseconds 400
Write-Host "`n*Important Notes: " -ForegroundColor Yellow
Write-Host "  1. Some prompts will appear during the process if running interactively."
